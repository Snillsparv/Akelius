# Socrates — fem frågekort

Svenskt arbetsnamn: Sokrates. Superenkel engelska, presens.
Nivåer: åk 6, åk 9, åk 12 ×2, universitet. Korten är oberoende av varandra.

---

## Kort 1 · Årskurs 6 — The man who never writes a book
...
- **barefoot** — *with no shoes on your feet*
...
- **Motiv:** A young student in ancient Greek clothes writes on a papyrus scroll with a reed pen. This picture supports the card's key idea: the students write the words down, so the ideas survive.
- **Bildtext:** *A student writes the words down.*
- **Shutterstock-sökning:** `ancient Greek scribe writing papyrus scroll illustration`
- **AI-prompt (alternativ):** Simple warm illustration of a young student in ancient Greek clothes writing on a papyrus scroll with a reed pen, plain background, children's book style.

---

## Kort 2 · Årskurs 9 — Answer with a question
...
- **saying** — *a short sentence that many people know and repeat*
- **rumor** — *a story people tell each other, but no one checks if it is true*
- **advertising** — *words and pictures that try to make you buy something*
...
- **Motiv:** A teenager looks at a smartphone that shows a big question mark, a symbol for checking if news, rumors, and ads are true.
- **Bildtext:** *Is this true? Check it first.*
- **Shutterstock-sökning:** `teenager smartphone question mark checking fake news illustration`
- **AI-prompt (alternativ):** Simple flat illustration of a teenager looking at a smartphone, a large question mark on the screen, symbolizing the check: is this news true?

---

## Kort 3 · Årskurs 12 (A) — The trial of the questioner
...
- **Motiv:** Jurors in ancient Athens drop small pebbles into two clay urns to vote guilty or not guilty, the voting method of Socrates' time. This picture explains the word 'jury'.
- **Bildtext:** *The jury votes with small stones.*
- **Shutterstock-sökning:** `ancient Greek jury voting urn pebbles illustration`
- **AI-prompt (alternativ):** Simple museum-style illustration of ancient Athenian jurors dropping small pebbles into two large clay urns to vote in court, guilty or not guilty, neutral background.

---

## Kort 4 · Årskurs 12 (B) — The soul is worth more than gold
...
- **soul** — *the inner part of you: your thoughts, feelings, and character*
- **fame** — *when many people know your name*
- **unexamined** — *not checked, not looked at*
- **cheat** — *to lie or trick people to win or get money*
...
- **Motiv:** A balance scale: a glowing heart on one side is heavier than a pile of gold coins on the other side. Symbol for 'a good soul matters more than money'.
- **Bildtext:** *A good soul weighs more than gold.*
- **Shutterstock-sökning:** `balance scale heart versus gold coins concept illustration`
- **AI-prompt (alternativ):** Minimal flat illustration of a balance scale where a glowing heart on one side outweighs a pile of gold coins on the other side, plain background, symbol that a good soul matters more than money.
...
- **dialogue** — *a written talk between two or more people*
- **expert** — *a person who knows very much about one thing*
- **refutation** — *showing, step by step, that an idea cannot stand*
...
- **Motiv:** An open papyrus scroll with short lines of a conversation between two speakers, like a theater script, with two small ancient Greek figures talking beside it. This picture explains the word 'dialogue'.
- **Bildtext:** *A dialogue is a written talk between people.*
- **Shutterstock-sökning:** `ancient Greek scroll two philosophers talking illustration`
- **AI-prompt (alternativ):** Minimal illustration of an open papyrus scroll showing short lines of a conversation between two speakers, two small ancient Greek figures with simple speech bubbles beside it, plain background.
