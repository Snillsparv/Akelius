...
- **empire** — *a large group of lands and peoples ruled by one ruler*
- **sorrow** — *a strong feeling of sadness*
- **wells** — *deep holes dug into the ground to reach water*
- **travelers** — *people who are on a journey, going from place to place*
...
## Kort 2 · Årskurs 9 — Words on a Rock, After Kalinga
...
- **faith** — *a religion, or a strong belief in something*
- **messengers** — *people sent to carry news or messages to others*
- **tradition** — *an old story or custom, passed on for a long time*
- **protects** — *keeps something safe from harm*
...
## Kort 4 · Årskurs 12 (B) — Silent for Two Thousand Years
...
## Kort 5 · Universitet — Edicts and Legends
...
- **edicts** — *official orders or rules announced by a ruler*
- **propaganda** — *pictures, words, and art that try to control what people think*
- **conviction** — *a strong, honest belief*
- **deciphered** — *worked out the meaning of a difficult or secret writing system*

### Huvudbild

- **Motiv:** On an old wooden library table, a fragment of grey sandstone with faint, unreadable third-century BC carved lines lies beside a bound palm-leaf manuscript tied with string, clearly much newer than the stone; a brown-skinned South Asian scholar's hand rests between the two objects, pointing from one to the other, face out of frame. Production note: no readable letters on the stone fragment or the manuscript's visible edge, no modern objects, soft library daylight.
- **Bildtext:** *An old stone and a newer manuscript tell two different kinds of stories.*
- **Shutterstock-sökning:** `ancient stone fragment palm leaf manuscript library table illustration`
- **AI-prompt (alternativ):** Photorealistic image of an old wooden library table with a fragment of grey sandstone bearing faint unreadable third-century BC carved lines beside a bound palm-leaf manuscript tied with string, clearly newer than the stone, a brown-skinned South Asian scholar's hand resting between the two objects pointing from one to the other, face out of frame, soft library daylight, no readable letters on either object, no modern objects, no flags, no recognisable face, no text, no letters, no numbers.
