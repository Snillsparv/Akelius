# Ferdinand Magellan — fem frågekort

Svenskt arbetsnamn: Ferdinand Magellan. Superenkel engelska, presens.
Nivåer: åk 6, åk 9, åk 12 ×2, universitet. Korten är oberoende av varandra.

---

## Kort 1 · Årskurs 6 — Five Ships and a Calm New Ocean
...
- **strait** — *a narrow line of water between two pieces of land*
- **spice** — *a dried plant part that gives food a strong taste, like pepper*
- **calm** — *quiet and still, without wind or big waves*
- **penguin** — *a black and white sea bird that swims but cannot fly*
...
## Kort 2 · Årskurs 9 — The Ocean Nobody Can Measure
...
- **clove** — *a spice, the dried flower bud of a tree*
- **leather** — *strong material made from the skin of an animal*
- **scurvy** — *a sickness that comes from too little fresh food*
- **gums** — *the soft pink flesh around the teeth*
...
- **Motiv:** The earth seen from space, the side that is almost entirely ocean: a blue disk with white clouds, only small edges of land at the rim, black space around. The picture helps explain the sentence about one third of the earth. Production note: no lines, grid, labels, letters, or numbers of any kind.
- **Bildtext:** *Seen from this side, the earth is almost all water.*
- **Shutterstock-sökning:** `earth from space pacific side water hemisphere vertical`
- **AI-prompt (alternativ):** Photorealistic vertical image of the earth seen from space, the side that is almost entirely ocean, a blue disk with white cloud patterns and only small edges of land at the rim, black space around, calm mood; no lines, no grid, no labels, no text, no letters, no numbers.

---

## Kort 3 · Årskurs 12 (A) — The Chief Who Says No
...
- **chief** — *the leader of a village or a people*
- **pact** — *a promise between two sides to help each other*
- **shallow** — *not deep*
- **warrior** — *a person who fights for his people*
...
- **Motiv:** A tall bronze statue of a warrior chief of the Philippines, strong figure with a traditional sword and round shield, on a plain stone pedestal, palm trees and a bright tropical sky behind. The picture helps explain the word 'chief' and shows how the islands remember him today. Production note: a generic figure, not a copy of a real monument; the pedestal completely bare; no plaque, letters, numbers, or symbols anywhere.
- **Bildtext:** *A statue for the chief who defends his island. Today he is a national hero.*
- **Shutterstock-sökning:** `bronze warrior chief statue philippines palm trees vertical`
- **AI-prompt (alternativ):** Photorealistic vertical image of a tall bronze statue of a warrior chief of the Philippines, strong figure with a traditional sword and round shield on a plain bare stone pedestal, palm trees and a bright tropical sky behind, dignified mood; generic figure, no plaque, no letters, no numbers, no symbols, no text.

---

## Kort 4 · Årskurs 12 (B) — The Interpreter from Malacca
...
- **slave** — *a person who is owned by another person and is not free*
- **interpreter** — *a person who turns words from one language into another*
- **will** — *a paper that says what happens to a person's things after death*
- **feast** — *a big meal for many people*

### Huvudbild

- **Motiv:** On the deck of a wooden ship anchored in a tropical bay about 500 years ago, a young Southeast Asian man in simple period clothes stands at the rail and speaks with islanders in an outrigger boat alongside; behind him, European sailors watch and listen. Production note: the interpreter is the central figure and is shown with dignity; no caricature; no chains; sails plain; no text, letters, or symbols anywhere.
- **Bildtext:** *One man on the ship speaks the language of the islands.*
- **Shutterstock-sökning:** `historical ship deck interpreter islanders outrigger boat tropical bay illustration`
- **AI-prompt (alternativ):** Warm realistic illustration: on the deck of a wooden ship anchored in a tropical bay about 500 years ago, a young Southeast Asian man in simple period clothes stands at the rail speaking with islanders in an outrigger boat alongside, European sailors behind him watching and listening, soft morning light, respectful mood; no caricature, no chains, sails plain, no text, no letters.

### Sidobild

- **Motiv:** A simple parchment-style map of the seas of Southeast Asia: a long peninsula, big islands to the south, and a group of many small islands to the east, warm paper tones, sea drawn with fine wave lines. The picture helps explain where Malacca and the islands to the east lie. Production note: absolutely no place names, letters, numbers, compass letters, or readable symbols on the map.
- **Bildtext:** *Many islands, many languages, and one trade language at sea.*
- **Shutterstock-sökning:** `old parchment map southeast asia islands blank no labels illustration`
- **AI-prompt (alternativ):** Simple parchment-style map of the seas of Southeast Asia in warm paper tones, a long peninsula, big islands to the south and a group of many small islands to the east, sea drawn with fine wave lines, vertical format; no place names, no letters, no numbers, no compass rose, no text.

---

## Kort 5 · Universitet — Eighteen Men and a Lost Day
