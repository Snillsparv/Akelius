# Jesus of Nazareth — fem frågekort
...
- **Motiv:** A shepherd in simple clothes from long ago carries one sheep on his shoulders; a small flock follows on a dry, hilly path. The picture explains the word 'shepherd' and the story of the lost sheep. Production note: classical, warm, and gentle; no halo, no religious symbols, no text or labels.
- **Bildtext:** *A shepherd finds his lost sheep and carries it home.*
- **Shutterstock-sökning:** `shepherd carrying sheep on shoulders flock dry hills illustration`
- **AI-prompt (alternativ):** Warm classical-style illustration: a shepherd in simple ancient clothes carries a sheep on his shoulders, a small flock follows on a dry hilly path in the eastern Mediterranean, soft evening light, gentle mood, no halo, no symbols, no text.
...
- **Motiv:** Two people stand face to face after a quarrel; one reaches out an open hand, and the other takes it. Their faces are calm and warm. The picture explains the word 'forgiveness'. Production note: simple, modern, culturally neutral clothes; no text or symbols in the image.
- **Bildtext:** *Forgiveness: you stop being angry.*
- **Shutterstock-sökning:** `two people reconciliation offering hand forgiveness illustration`
- **AI-prompt (alternativ):** Simple warm illustration: two people after a quarrel, one reaches out an open hand and the other takes it, calm faces, soft colors, neutral modern clothes, hopeful mood, no text, no symbols.
...
- **parable** — *a short story with a lesson inside*
- **foreigner** — *a person from another land or group*
- **wound** — *a hurt place on the body*
- **look down on** — *to think that a person is less important*

### Huvudbild

- **Motiv:** Classical-style illustration of the parable scene: on a dusty road between rocky hills, a man kneels beside a hurt traveler, gives him water, and wraps a clean cloth around his arm. A donkey waits nearby. Far away on the road, two figures walk on. Production note: gentle scene — no blood, no frightening details; the hurt is shown only with simple bandages; no text or signs in the image.
- **Bildtext:** *One man stops and helps the hurt traveler.*
- **Shutterstock-sökning:** `good samaritan helping injured traveler road classical painting`
- **AI-prompt (alternativ):** Respectful classical-style illustration: on a dusty road between rocky hills in the ancient Middle East, a man kneels beside a hurt traveler, gives him water and wraps a cloth bandage around his arm, a donkey waits nearby, two small figures walk away in the distance, warm light, gentle mood, no blood, no text.

### Sidobild

- **Motiv:** A modern, everyday scene: on a city street, a young person helps a stranger who has fallen, picking up his dropped bags; the two look like they come from different backgrounds. The picture shows that the lesson of the parable lives today. Production note: culturally neutral, friendly; no readable text on signs, shirts, or bags.
- **Bildtext:** *The lesson lives today: help, even a stranger.*
- **Shutterstock-sökning:** `person helping stranger who fell street kindness diverse illustration`
- **AI-prompt (alternativ):** Warm flat illustration: on a modern city street, a young person helps a stranger who has fallen, picking up dropped bags, the two people from visibly different backgrounds, friendly faces, soft colors, no readable text on signs, shirts, or bags, no text.
...
- **follower** — *a person who believes in a teacher and lives by his words*
- **faith** — *a strong belief in a religion*
- **calendar** — *the way we count and name days and years*
- **monk** — *a man who lives a simple, religious life*

### Huvudbild

- **Motiv:** A stylized antique-looking map of the Mediterranean world with soft golden arrows: they start at the eastern shore of the sea and spread west and north around the whole sea, into Europe, North Africa, and Asia. Small simple fish symbols travel along the arrows. Production note: NO country names, city names, or any readable words on the map — only shapes, arrows, and symbols; no crosses.
- **Bildtext:** *From one small land, the teaching travels around a great sea.*
- **Shutterstock-sökning:** `ancient mediterranean map spread routes arrows illustration no labels`
- **AI-prompt (alternativ):** Stylized antique-looking map of the Mediterranean world with no text or labels at all, soft golden arrows flowing from the eastern shore of the sea westward and northward around the whole Mediterranean into Europe, North Africa, and western Asia, small simple fish outline symbols along the arrows, warm educational style, no crosses, absolutely no words on the map.
...
- **believer** — *a person who belongs to a religion*
- **neutral** — *not taking any side*
- **historian** — *a person who studies the past*

### Huvudbild

- **Motiv:** A scribe in simple clothes from Roman times writes with a reed pen on a papyrus sheet by the light of a small oil lamp, in a plain stone room in the eastern Mediterranean. Finished scrolls lie beside him. Production note: the writing must be decorative, generic strokes only — no real readable words or names; no religious symbols in the room.
- **Bildtext:** *Many years after his death, followers write his story down.*
- **Shutterstock-sökning:** `ancient scribe writing papyrus oil lamp stone room illustration`
- **AI-prompt (alternativ):** Warm, quiet illustration: a scribe in simple first-century clothes writes with a reed pen on papyrus by the light of a small oil lamp, plain stone room in the eastern Mediterranean, finished scrolls beside him, the writing shown only as decorative unreadable strokes, no religious symbols, no readable text.

### Sidobild

- **Motiv:** A modern researcher with thin gloves studies a small, damaged papyrus fragment under glass, with a magnifying lens and soft desk light. The picture supports the word 'historian': scholars today study very old pages to learn what really happened. Production note: any letterforms on the fragment must be generic and unreadable; no names, no labels, no readable text anywhere.
- **Bildtext:** *A historian studies a very old page.*
- **Shutterstock-sökning:** `researcher gloves studying ancient papyrus fragment magnifying glass`
- **AI-prompt (alternativ):** Photorealistic scene: a modern researcher with thin cotton gloves studies a small damaged papyrus fragment under glass with a magnifying lens, soft desk light, quiet library mood, the letterforms on the fragment generic and unreadable, no names, no labels, no readable text.
