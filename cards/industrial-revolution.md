# The Industrial Revolution — fem frågekort
...
## Kort 1 · Årskurs 6 — From wheel to mill by the river
...
- **spin** — *to turn cotton or wool into long thread*
- **mill** — *a large building full of machines that make cloth*
- **engine** — *a machine that makes power from burning fuel*
- **chimney** — *a tall pipe that carries smoke up into the sky*
...
## Kort 2 · Årskurs 9 — Twelve hours in the mill
...
- **mine** — *a deep hole or tunnel where workers dig out coal*
- **cholera** — *a dangerous disease that spreads through dirty water*
- **union** — *a group of workers who join together to ask for better and safer work*
- **crowded** — *full of too many people in a small space*
...
- **Motiv:** At the dark mouth of a coal mine cut into a hillside, a boy of about eleven stands holding a small metal lamp, a line of adult miners with baskets walking in behind him. Supports the word 'mine'. Production note: no visible injury, no dirt suggesting danger beyond normal coal dust, no readable signs, calm and dignified mood.
- **Bildtext:** *Other children work underground, in mines far from any mill.*
- **Shutterstock-sökning:** `coal mine entrance child miner lamp historical illustration`
- **AI-prompt (alternativ):** Vertical historical illustration of the dark entrance to a coal mine cut into a hillside, a boy of about eleven standing with a small metal lamp, a line of adult miners with baskets walking in behind him, cool early morning light; no visible injury, no signs, no text, no letters.

---

## Kort 3 · Årskurs 12 (A) — The engine that changes distance
...
- **patent** — *an official paper that gives one person the right to an invention*
- **canal** — *a waterway that people dig for boats to travel on*
...
- **Motiv:** Inside a workshop, an engineer in period clothes leans over a large stationary steam engine, checking a valve on its side, pipes and a big flywheel around him, tools on a nearby bench. Supports the word 'engineer'. Production note: no readable gauges, dials, or labels with numbers or letters, calm focused mood.
- **Bildtext:** *An engineer studies the engine closely and makes it stronger and safer.*
- **Shutterstock-sökning:** `engineer steam engine workshop nineteenth century historical illustration`
- **AI-prompt (alternativ):** Vertical historical illustration of an engineer in period clothes leaning over a large stationary steam engine inside a workshop, checking a valve on its side, pipes and a big flywheel around him, tools resting on a nearby bench, warm workshop light; no readable gauges, no numbers, no text, no letters.

---

## Kort 4 · Årskurs 12 (B) — Cotton from three continents
...
- **enslaved** — *forced to work without pay and owned by another person*
- **weaver** — *a person who makes cloth from thread, often by hand*
- **income** — *the money a person earns from work*
- **decade** — *a period of ten years*

### Huvudbild

- **Motiv:** A busy English port dock in the early eighteen hundreds. Workers unload heavy bales of raw cotton from a large sailing ship onto the quay, other workers carry the bales toward waiting carts, more ships and cranes stand in the background. Production note: no readable signs, flags, or names on the ships, no visible injury, ordinary busy working mood.
- **Bildtext:** *Ships bring raw cotton from far away. British mills turn it into cloth.*
- **Shutterstock-sökning:** `cotton bales port dock ship unloading nineteenth century historical illustration`
- **AI-prompt (alternativ):** Historical illustration of a busy English port dock in the early nineteenth century, workers unloading heavy bales of raw cotton from a large sailing ship onto the quay, other workers carrying bales toward waiting carts, more ships and cranes in the background, soft morning light; no readable signs, no flags, no names, no text, no letters.
...
## Kort 5 · Universitet — Revolution or slow change?
...
- **colony** — *a land ruled and used by another, more powerful country*
- **divergence** — *the point where two similar things start to become very different*
- **inspector** — *a person whose job is to check that rules are followed*
