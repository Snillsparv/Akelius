# Muhammad — fem frågekort

Svenskt arbetsnamn: Muhammed. Superenkel engelska, presens.
Nivåer: åk 6, åk 9, åk 12 ×2, universitet. Korten är oberoende av varandra.
Känslighetsregel för hela setet: profeten Muhammed får ALDRIG avbildas —
ingen person i någon bild får kunna tolkas som honom. Ingen arabisk kalligrafi
i bilderna (AI-genererad pseudoarabiska är respektlös; riktig skrift blir läsbar
text) — använd geometriska mönster i stället. Tron beskrivs neutralt och
respektfullt: "Muslims believe...".
...
- **angel** — *a messenger from God, in many religions*
...
- **Motiv:** The dark opening of a small empty cave high in a sunlit rocky mountain (like the cave of Hira on the mountain near Mecca), seen from outside. The picture explains the word 'cave'. Production note: the cave must be empty — no people anywhere; the Prophet Muhammad must NEVER be depicted. No readable text, signs, watermarks, or Arabic calligraphy. Peaceful, not frightening.
- **Bildtext:** *A quiet cave high up in the mountains.*
- **Shutterstock-sökning:** `cave opening rocky desert mountain empty`
- **AI-prompt (alternativ):** Photorealistic vertical view of a small dark cave opening high on a rocky desert mountain near Mecca, seen from outside, empty cave, no people, soft morning light, peaceful quiet mood, no text, no writing, no calligraphy.
...
- **Motiv:** Warm illustration of an early oasis town in Arabia: date palms, simple mud-brick houses, and a shaded courtyard where ordinary townspeople share bread and dates with poorer neighbors and children. Production note: the Prophet Muhammad must NEVER be depicted — no central teacher or leader figure; only generic townspeople, and no one may be interpretable as him. No readable text, signs, or watermarks; no Arabic calligraphy or writing anywhere; nothing in the image may reveal the answer in text. Friendly, respectful, not scary.
- **Bildtext:** *In a town with palm trees, people share food and help each other.*
- **Shutterstock-sökning:** `oasis town date palms people sharing food illustration`
- **AI-prompt (alternativ):** Warm storybook illustration of an early oasis town in Arabia, like early Medina: date palms, simple mud-brick houses, ordinary townspeople sharing bread and dates with poorer neighbors and children in a shaded courtyard, no central figure, no one shown as a prophet or leader, soft warm colors, friendly calm mood, no text, no writing, no calligraphy.
...
- **recite** — *to say a text out loud from memory*
- **by heart** — *from memory, without reading*
- **holy** — *very special and important in a religion*
- **Arabic** — *the language of Arabia, spoken in many countries today*

### Huvudbild

- **Motiv:** Quiet still life: a large closed old book with a plain leather cover, decorated only with a simple geometric star pattern, rests on a carved wooden book stand; a small oil lamp burns beside it in a dark room. Production note: the book must be closed — no visible script or letters; no Arabic calligraphy and no AI-generated imitation Arabic anywhere (geometric patterns only); the Prophet Muhammad must NEVER be depicted. No readable text, signs, or watermarks; nothing in the image may reveal the answer in text. Calm and respectful.
- **Bildtext:** *An old book on a wooden stand. Many people know every word by heart.*
- **Shutterstock-sökning:** `closed old leather book wooden stand oil lamp`
- **AI-prompt (alternativ):** Photorealistic still life: a large closed antique book with a plain dark leather cover decorated only with a simple embossed geometric star pattern, resting on a carved wooden folding book stand, a small glowing oil lamp beside it, dark quiet room, warm light, respectful mood, no visible letters or script, no calligraphy, no text.
...
- **Motiv:** Close-up of an antique brass astrolabe held up against a starry night sky over a dark desert horizon. The picture explains the word 'astronomy'. Production note: any engraving on the astrolabe must be blurred, generic, and unreadable — no real letters, numbers, or calligraphy; the Prophet Muhammad must NEVER be depicted — no people, or at most one anonymous hand holding the instrument. No readable text, signs, or watermarks.
- **Bildtext:** *An old tool for measuring the stars. The study of stars is astronomy.*
- **Shutterstock-sökning:** `brass astrolabe night sky stars close up`
- **AI-prompt (alternativ):** Photorealistic vertical close-up: a hand holds an antique brass astrolabe up against a deep blue starry night sky over a dark desert horizon, soft moonlight reflections on the metal, all engravings blurred and unreadable, no letters, no numbers, no calligraphy, no text.
...
- **hadith** — *a story about the words or actions of Mr X*
- **generation** — *parents are one generation; their children are the next*
- **collection** — *many things gathered together in one book or place*

### Huvudbild

- **Motiv:** A conservator with white gloves carefully studies very old, worn manuscript pages in a modern archive, with a magnifying glass and soft lamp light; the pages are angled away from the camera. Production note: no writing on the pages may be readable or reproducible — choose an angle, distance, or soft blur so no script can be seen clearly; never AI-generate imitation Arabic script; the Prophet Muhammad must NEVER be depicted, and no figure may be interpretable as him. No readable text, labels, signs, or watermarks; nothing in the image may reveal the answer in text. Quiet and respectful.
- **Bildtext:** *A researcher studies very old pages with great care.*
- **Shutterstock-sökning:** `conservator white gloves ancient manuscript archive`
- **AI-prompt (alternativ):** Photorealistic scene in a modern archive: a conservator in white gloves leans over very old, worn parchment pages on a table, magnifying glass in hand, soft warm lamp light, the pages angled away from the camera and softly out of focus so no writing is visible, quiet focused mood, no readable script, no calligraphy, no text.
