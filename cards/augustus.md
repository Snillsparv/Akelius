# Augustus — fem frågekort

Svenskt arbetsnamn: Augustus. Superenkel engelska, presens.
Nivåer: åk 6, åk 9, åk 12 ×2, universitet. Korten är oberoende av varandra.

---

## Kort 1 · Årskurs 6 — A Boy with a Powerful Name
...
## Kort 2 · Årskurs 9 — From Brick to Marble
...
- **brick** — *a small building block of baked clay*
- **marble** — *a fine, shiny stone for beautiful buildings*

### Huvudbild

- **Motiv:** Warm illustration of a building site in ancient Rome: workers raise a white marble column with a tall wooden crane; a half-finished marble temple shines in the sun; older houses of brick stand in the background. Peaceful mood, no soldiers. Production note: no readable inscriptions on buildings or anywhere else; the subject's name must not appear. The AI prompt is the primary path for this scene; the stock query is a generic fallback.
- **Bildtext:** *Workers build with white marble. The city changes.*
- **Shutterstock-sökning:** `ancient rome construction workers temple illustration`
- **AI-prompt (alternativ):** Warm historical illustration: a building site in ancient Rome, workers raise a white marble column with a tall wooden crane, a half-finished marble temple shines in the sunlight, simple brick houses in the background, calm and peaceful mood, no soldiers, no text or letters anywhere in the image.

### Sidobild

- **Motiv:** A simple two-part comparison image: on the left, a rough wall of red-brown bricks; on the right, a smooth, polished white marble wall. This explains the words 'brick' and 'marble'. Production note: this exact comparison will not exist as one stock photo - produce it with the AI prompt or an in-house illustrator; no text anywhere.
- **Bildtext:** *Brick is baked clay. Marble is a fine, shiny stone.*
- **Shutterstock-sökning:** `brick wall texture and white marble texture`
- **AI-prompt (alternativ):** Clean educational image split in two halves: left half a rough wall of red-brown ancient bricks, right half a smooth polished white marble wall, even soft light, simple and clear, no text or letters anywhere in the image.

---

## Kort 3 · Årskurs 12 (A) — Power without a Crown
...
- **title** — *an official name for a person's job or rank*
- **princeps** — *a Latin word: the first citizen, the first man of the state*
- **senate** — *a group of powerful men who guide the Roman state*
- **republic** — *a state without a king; the people choose their leaders*

### Huvudbild

- **Motiv:** Sober illustration: a calm, middle-aged Roman leader in a plain white toga sits on a simple wooden bench among senators in a marble hall; he wears no crown and has no special seat; the senators speak with him as with an equal. Dignified, quiet mood. Production note: no readable inscriptions, no 'SPQR' letters, no banners with text; the subject's name must not appear.
- **Bildtext:** *No crown, no throne. He sits like one citizen among many.*
- **Shutterstock-sökning:** `roman leader toga senators marble hall illustration`
- **AI-prompt (alternativ):** Sober historical illustration: a calm middle-aged Roman leader in a plain white toga sits on a simple wooden bench among Roman senators in a marble hall, no crown, no throne, the senators talk with him as equals, dignified quiet mood, warm light, no violence, no text or letters anywhere in the image.
...
## Kort 4 · Årskurs 12 (B) — The Face That Never Grows Old
...
- **statue** — *a figure of a person, made of stone or metal*
- **golden age** — *a very good and happy time*
- **advertising** — *pictures and words that try to sell something*
- **propaganda** — *pictures, words, and art that try to control what people think*
...
- **Motiv:** Extreme close-up of an ancient Roman coin with a man's head in profile, worn metal texture. IMPORTANT production note: real coins of this emperor carry his name - all letters and inscriptions must be removed, blurred, or unreadable; use the AI image if no clean stock photo exists.
- **Bildtext:** *A small coin carries a face across the empire.*
- **Shutterstock-sökning:** `ancient roman coin portrait profile closeup`
- **AI-prompt (alternativ):** Close-up illustration of an ancient Roman coin showing a man's head in profile, worn gold-silver metal texture, plain dark background, all letters and inscriptions removed, no text anywhere in the image.
...
- **carve** — *to cut letters or pictures into stone or wood*
...
- **Motiv:** A weathered ancient temple wall covered with long lines of carved Latin text, photographed at an angle in warm light, so that the letters are visibly old but not readable. IMPORTANT production note: the real inscription carries the emperor's name and titles - in the final crop all letters must be unreadable or blurred; no museum signs or plaques; search keywords must never appear in student-visible text or alt-text. If no clean crop is possible, use the AI image.
- **Bildtext:** *The emperor writes his own story, and workers carve it in stone.*
- **Shutterstock-sökning:** `temple of augustus ankara ancient wall inscription`
- **AI-prompt (alternativ):** Photorealistic image of a weathered ancient temple wall densely covered with faint, worn, unreadable carved letters, warm evening light raking across the stone, quiet and monumental mood, no people, no signs, no readable text anywhere in the image.

### Sidobild

- **Motiv:** Close-up of a stonemason's hands holding a chisel and a small hammer, cutting marks into a marble surface. This explains the word 'carve'. Production note: the marks in the stone must be generic and unreadable; no real words or names anywhere.
- **Bildtext:** *A worker carves signs into hard stone. Stone words last very long.*
- **Shutterstock-sökning:** `stonemason hands chisel hammer carving marble closeup`
- **AI-prompt (alternativ):** Photorealistic close-up: a craftsman's hands hold a chisel and a small hammer and cut marks into a white marble surface, fine stone dust, warm workshop light, the marks generic and unreadable, no text or letters anywhere in the image.
