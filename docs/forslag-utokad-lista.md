...
Masterlistan med 50 ämnen ger 250 kort när leverans 8 är klar. För 600 kort
behövs ungefär 70 ämnen till med fem kort per ämne, eller fler ämnen om
mindre gestalter får två eller tre kort som Roger föreslagit. Listan nedan
har 84 ämnen i tre prioritetsnivåer. Nivå 1 ensam ger 600 kort. Nivå 2 och 3
räcker till drygt 800 kort om allt produceras.

Produktionstakt hittills: en körning klarar 5-7 ämnen, alltså 25-35 kort med
bilder, granskning och svenska. Bildkostnaden är cirka 0,34 USD per kort.

## Principer för urvalet

1. Idéhistoria och utveckling före krig och kungar, enligt Roger.
2. Global balans: ungefär en fjärdedel av ämnena från Afrika, en fjärdedel
   från Asien, en åttondel från Latinamerika och Mellanöstern, resten Europa
   och Nordamerika. Klassrummen finns i Tanzania och Bhutan.
3. Kvinnor i minst en fjärdedel av personseten.
4. Varje ämne ska bära en ledtrådskedja utan svarsläcka och ha bildmotiv som
   klarar textförbudet.
5. Känsliga ämnen (folkmord, diktatorer, nutida konflikter) endast där de är
   nödvändiga för förståelsen, med samma varsamhet som i leverans 7.

## Nivå 1: 70 ämnen, ger 600 kort (Rogers uttalade önskemål först)
...
| 66 | Emmy Noether | matematik | 3 | Symmetri och bevarandelagar, kvinnan utan lön |
| 67 | Srinivasa Ramanujan | matematik | 3 | Kontoristen från Madras, breven till Cambridge |
...
| 120 | Elisabet I | Europa | 3 | Drottningen utan kung, armadan, Shakespeares tid |

## Nivå 2: 10 ämnen till, ger 640 kort

| # | Ämne | Block | Kort | Motivering |
|---|---|---|---|---|
| 121 | William Shakespeare | Europa | 3 | Teatern för alla, orden vi använder |
| 122 | Peter den store | Europa | 3 | Skeppsbyggaren, Sankt Petersburg, Europa med våld |
| 123 | Ryska revolutionen | 1900-talet | 5 | 1917, Lenin, inbördeskriget, sovjetstaten |
| 124 | Den stora depressionen | 1900-talet | 3 | Kraschen 1929, arbetslösheten, New Deal, världen |
| 125 | Kinas revolution 1949 | 1900-talet | 5 | Mao, det stora språnget, kulturrevolutionen, sakligt |
| 126 | Vietnamkriget | 1900-talet | 3 | Tv-kriget, byarna, protesterna, slutet 1975 |
| 127 | Europeiska unionen | 1900-talet | 3 | Kol och stål, freden som idé, utvidgningen |
| 128 | Internet och webben | utveckling | 5 | Arpanet, Berners-Lee, mejlet, vad som förändrades |
| 129 | Elektriciteten | utveckling | 5 | Faraday, Edison, Tesla, ljuset i byn |
| 130 | Vaccinet | utveckling | 3 | Jenner och kokopporna, smittkoppornas utrotning 1980 |

## Nivå 3: 4 ämnen i reserv

| # | Ämne | Block | Kort | Motivering |
|---|---|---|---|---|
| 131 | Flyget | utveckling | 3 | Bröderna Wright, tolv sekunder, världen krymper |
| 132 | Fotografiet | utveckling | 3 | Daguerre, bilden av kriget, alla får ett ansikte |
| 133 | Beethoven | Europa | 3 | Dövheten, nionde symfonin, musiken som idé |
| 134 | Klimatvetenskapen | vetenskap | 3 | Arrhenius 1896, Keelingkurvan, vad vi vet |

## Frågor som behöver Rogers eller Jonas svar innan produktion

1. Får mindre gestalter tre kort (åk 6, åk 12, universitet) i stället för
   fem, som listan föreslår? Roger öppnade för 1-7 kort per ämne 2026-08-23.
2. Nya kategorietiketter på korten: förslag `science`, `mathematics`,
   `ideas`, `africa`, `asia`, `latin america`, `middle east`, `twentieth
   century`, `inventions`. Etiketten trycks på kortet och får inte vara lika
   med svaret.
3. Ordningen: förslaget är att börja med block vetenskap och matematik
   (rad 51-69), sedan Afrika (87-96), sedan Asien, eftersom det svarar mot
   Rogers önskemål och målgruppen.
4. Nivå 3-kort (de enklaste) är fortfarande inte producerade; ska de läggas
   till i nästa etapp eller väntar de på baksidestexterna?
