...
2. **Anonymiseringen bevaras**: Mr X → herr X, Miss X → fröken X, Mrs X → fru X, King X → kung X, Captain X → kapten X, Brother X → broder X, Movement X → rörelsen X, Period X → perioden X, Master X →
